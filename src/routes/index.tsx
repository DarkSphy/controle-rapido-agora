...
import { actions, useStore, productEffectiveStock, formatBRL, priceFromCostMargin } from "@/lib/store";
  ...
  return (
    <div className="px-4 md:px-8 py-6 md:py-10 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-8">
        <Stat icon={TrendingUp} label="Entradas hoje" value={today.ins} accent="success" />
...
}: { icon: any; label: string; value: number | string; accent: "success" | "primary" | "destructive" | "default"; small?: boolean }) {
  const colors = {
