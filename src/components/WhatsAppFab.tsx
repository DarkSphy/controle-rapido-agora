...
export function WhatsAppFab() {
  return (
    ...
    >
      ...
      <span className="relative flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5a] text-white rounded-full shadow-xl px-4 py-3 md:px-5 md:py-3.5 font-semibold transition-transform hover:scale-105">
